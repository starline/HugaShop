...
{block name=content}
	...
	<div id="path">
		<ul itemscope itemtype="https://schema.org/BreadcrumbList">
			...
			{foreach $category->path as $path}
				<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
					<a href="/{$path->url}" itemprop="item"><span itemprop="name">{$path->name}</span>
	...
	{if 'product_content'|user_access AND $product->id}
		<div class="admin_edit">
			<a href="/admin/product/{$product->id}" data-bs-toggle="tooltip" title="Редактировать товар">Редактировать
				товар</a>
		</div>
	{/if}
