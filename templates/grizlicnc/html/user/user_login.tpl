...
{block name=content}
	<div class="login_wrap my-5">
		...
		<h1>{'Вход'|trans} <a class="ajax" href="{'UserRegister'|linkLang}">{'Регистрация'|trans} →</a></h1>
		...
		<form class="form-signin" method="post" action="{'UserLogin'|linkLang}">
			{getCSRFInput}
			...
			<div class="row align-items-center">
				...
				<div class="col-6 text-end">
					<a class="ajax" href="{'UserPasswordRemind'|linkLang}">{'Забыл пароль?'|trans}</a>
				</div>
			</div>
