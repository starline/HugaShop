    ...
    <form class="form" method="post">
        ...
        <div class="row g-4">
            <div class="col-lg-4">
                ...
                <input class="form-control {if date|in_array:$form_invalid}is-invalid{/if}" value="{$date}" name="date"
                    type="date" id="date" />
                <div class="invalid-feedback">Выберите дату</div>
            </div>
            <div class="col-lg-4">
                <label class="form-label" for="time">Время</label>
                <input class="form-control {if time|in_array:$form_invalid}is-invalid{/if}" value="{$time}" name="time"
                    type="time" id="time" />
            ...
            <div class="col-lg-4">
                ...
                <input class="form-control {if phone|in_array:$form_invalid}is-invalid{/if}" value="{$phone}" name="phone"
                    maxlength="32" type="text" id="phone" placeholder="Телефон" />
