...
<table cellspacing="0" cellpadding="0" border="0">
    <tr>
        ...
        <td style="text-align: left;" width="80%">
            <div style="font-size: 12;">{$payment_method->settings->recipient}</div><br />
            P/p {$payment_method->settings->account},<br />
            Банк {$payment_method->settings->bank}, МФО {$payment_method->settings->mfo},<br />
            Юр. адреса: {$payment_method->settings->recipient_adress},<br />
            код за ЄДРПОУ {$payment_method->settings->edrpou}, ІПН {$payment_method->settings->ipn}<br />
