...
class FinancePayment extends BaseModel
{
    protected static $table_fields = [
        ...
        'purse_amount' =>           ['type' => 'decimal',   'length' => 10.2,   'def' => 0.00,                  'access' => false],
        'amount' =>                 ['type' => 'decimal',   'length' => 10.2,   'def' => 0.00],
        'currency_amount' =>        ['type' => 'decimal',   'length' => 10.2,   'def' => 0.00],
        'currency_rate' =>          ['type' => 'decimal',   'length' => 10.4,   'def' => 1.0000],
